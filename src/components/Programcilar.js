...
export default function Programcilar() {
  ...
  const oneCikaninIsmi = () => {
    const secilenProgramci = programcilar.find(dev => dev.id === oneCikanId)
    //!!!Programcı listesinde, seçilen programcının ID'sini ara ve bu programcı'nın id'sini oneCıkanId'yle eşle. eğer bir eşleşme bulunursa, bu programcının adını dön!!!
    return secilenProgramci ? secilenProgramci.isim : "";
    // Bunu sona bırakın!
